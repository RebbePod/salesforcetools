...
# Extension - Salesforce API Name Formatter
Replaces spaces and invalid characters in a form input to follow Salesforce API name rules.

[Link to repo](https://github.com/RebbePod/salesforceapiformatter) 
